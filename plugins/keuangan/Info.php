...
return [
    ...
    'install'       =>  function () use ($core) {
        ...
        $core->mysql()->pdo()->exec("ALTER TABLE `mlite_jurnal`
        ...
        $core->mysql()->pdo()->exec("ALTER TABLE `mlite_rekeningtahun`
        ...
        $core->mysql()->pdo()->exec("CREATE TABLE IF NOT EXISTS `mlite_subrekening` (
          `kd_rek` varchar(15) NOT NULL,
          `kd_rek2` varchar(15) NOT NULL
        ) ENGINE=InnoDB DEFAULT CHARSET=latin1;");

        $core->mysql()->pdo()->exec("ALTER TABLE `mlite_subrekening`
